...
namespace Tetris.Shape
{
    ...
    {
        public TetrisShapeO(Vector2Int origin, Sprite color)
        {
            ...
            rotateRuleUp = new RotateRule(1, 1, false);
            rotateRuleDown = new RotateRule(1, 1, false);
            rotateRuleLeft = new RotateRule(1, 1, false);
            rotateRuleRight = new RotateRule(1, 1, false);
        }
    }
}